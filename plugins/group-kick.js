...
if (user === ownerGroup) return conn.reply(m.chat, `✿ Aviso:\n\n✎ Este usuario es Creador del grupo. No pude eliminarlo.`, m)
if (user === ownerBot) return conn.reply(m.chat, `✿ Aviso:\n\n✎ Este usuario es Staff de Deymoon Club. No fue posible eliminarlo.`, m)
